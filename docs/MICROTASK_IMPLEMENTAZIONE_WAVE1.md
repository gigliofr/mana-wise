...
- [ ] MT-2.7 Integrare badge per-carta nel frontend deck editor/library

## Feature 1 - Mana curve analyzer avanzato (deck endpoint)
- [x] MT-1.1 Aggiungere endpoint `GET /api/v1/decks/{id}/analysis`
- [ ] MT-1.2 Estrarre breakdown CMC per tipo (creature/instant/sorcery/enchantment/artifact/planeswalker)
...
- [ ] MT-3.1 Esporre endpoint deck-centric `POST /api/v1/decks/{id}/simulate`
...
## Note
- L’implementazione attuale mantiene retrocompatibilita con endpoint legacy.
- I microtask non completati verranno implementati nei prossimi commit incrementali.
